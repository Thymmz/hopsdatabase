...
public class HopsController {
    ...
    @GetMapping
    public Hops getHops(@RequestParam("INT_ID") String INT_ID, @RequestParam("INT_CC") String INT_CC, @RequestParam("INT_INST") Integer INT_INST, @RequestParam("INT_SERVICE_ID") String INT_SERVICE_ID){
        return hopsService.getHopsFromDB(INT_ID, INT_CC, INT_INST, INT_SERVICE_ID);
    }
}
